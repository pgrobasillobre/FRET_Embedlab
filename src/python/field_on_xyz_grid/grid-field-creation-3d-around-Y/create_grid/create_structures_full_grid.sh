...
# respect that axis, and then a set of translations 
# and rotations are applied, according to the options
# given (see below)
#
...
#
angle_step=5 # Define the step size for angle
#
# =================================================
# =================== BASH CODE ===================
#
...
#  ok 3
   ...
   mv final_molecules_z_y/*xyz "grid/${counter}"
...
for i in *; do tail -1  $i | cat >> tmp_xyz ; done 
